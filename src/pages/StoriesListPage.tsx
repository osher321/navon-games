...
const SEO_COPY: Record<string, { title: string; description: string }> = {
  hebrew: {
    ...
    description: '30 סיפורים מקוריים בעברית לתרגול קריאה והבנת הנקרא, בכל רמות הקושי - לחצו על כל מילה כדי לשמוע הגייה וללמוד את משמעותה.',
  },
  english: {
    title: 'סיפורים באנגלית ללימוד אוצר מילים | נבון משחקים',
    description: '30 סיפורים קצרים ומקוריים באנגלית ללימוד אוצר מילים, בכל רמות הקושי - לחצו על כל מילה כדי לשמוע הגייה וללמוד את התרגום לעברית.',
  },
  spanish: {
    title: 'סיפורים בספרדית ללימוד אוצר מילים | נבון משחקים',
    description: '30 סיפורים קצרים ומקוריים בספרדית ללימוד אוצר מילים, בכל רמות הקושי - לחצו על כל מילה כדי לשמוע הגייה וללמוד את התרגום לעברית.',
  },
}
