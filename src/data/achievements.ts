...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: 'soccer_first_goal',
    icon: '⚽',
    nameKey: 'ach_soccer_first',
    descKey: 'ach_soccer_first_desc',
    check: (p) => (p.bestScores.soccer ?? 0) >= 1,
  },
  {
    id: 'soccer_hattrick',
    icon: '🎩',
    nameKey: 'ach_soccer_hattrick',
    descKey: 'ach_soccer_hattrick_desc',
    check: (p) => (p.bestScores.soccer ?? 0) >= 3,
  },
  {
    id: 'soccer_top_scorer',
    icon: '👑',
    nameKey: 'ach_soccer_topscorer',
    descKey: 'ach_soccer_topscorer_desc',
    check: (p) => (p.bestScores.soccer ?? 0) >= 8,
  },
  {
    id: 'daily_challenge_first',
    icon: '🏆',
    nameKey: 'ach_daily_first',
    descKey: 'ach_daily_first_desc',
    check: (p) => p.dailyChallengeTotalCompleted >= 1,
  },
  {
    id: 'daily_streak_7',
    icon: '🔥',
    nameKey: 'ach_daily_streak7',
    descKey: 'ach_daily_streak7_desc',
    check: (p) => p.dailyChallengeStreak >= 7,
  },
  {
    id: 'daily_streak_30',
    icon: '🔥',
    nameKey: 'ach_daily_streak30',
    descKey: 'ach_daily_streak30_desc',
    check: (p) => p.dailyChallengeStreak >= 30,
  },
  {
    id: 'daily_perfect',
    icon: '💯',
    nameKey: 'ach_daily_perfect',
    descKey: 'ach_daily_perfect_desc',
    check: (p) => p.recentGames.some((g) => g.gameId === 'daily_challenge' && g.perfect),
  },
  {
    id: 'daily_xp_1000',
    icon: '⭐',
    nameKey: 'ach_daily_xp1000',
    descKey: 'ach_daily_xp1000_desc',
    check: (p) => p.dailyChallengeTotalXP >= 1000,
  },
]
